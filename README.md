...
<h1 align="center">Cxy Food Menu</h1>

**🌱 基于 Vue3 全家桶、TS/JS、Vite 构建工具开发的项目**
...
👓 [点击这里](http://food.alongweb.top/preview)
...
```shell
# 克隆项目
git clone https://github.com/YangWenLong123/cxy-food-menu.git
